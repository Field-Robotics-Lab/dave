...
// Gazebo plugin
#include <uuv_dave_world_plugins/UnderwaterCurrentPlugin.hh>
...
#include <uuv_dave_world_ros_plugins_msgs/SetCurrentModel.h>
#include <uuv_dave_world_ros_plugins_msgs/GetCurrentModel.h>
#include <uuv_dave_world_ros_plugins_msgs/SetCurrentVelocity.h>
#include <uuv_dave_world_ros_plugins_msgs/SetCurrentDirection.h>
#include <uuv_dave_world_ros_plugins_msgs/SetOriginSphericalCoord.h>
#include <uuv_dave_world_ros_plugins_msgs/GetOriginSphericalCoord.h>
...
namespace uuv_simulator_ros
{
  class UnderwaterCurrentROSPlugin : public gazebo::UnderwaterCurrentPlugin
  {
    ...
    public: bool UpdateCurrentVelocityModel(
        uuv_dave_world_ros_plugins_msgs::SetCurrentModel::Request& _req,
        uuv_dave_world_ros_plugins_msgs::SetCurrentModel::Response& _res);
    ...
    public: bool GetCurrentVelocityModel(
        uuv_dave_world_ros_plugins_msgs::GetCurrentModel::Request& _req,
        uuv_dave_world_ros_plugins_msgs::GetCurrentModel::Response& _res);
    ...
    public: bool UpdateCurrentVelocity(
        uuv_dave_world_ros_plugins_msgs::SetCurrentVelocity::Request& _req,
        uuv_dave_world_ros_plugins_msgs::SetCurrentVelocity::Response& _res);

    /// \brief Service call to update the mean value of the horizontal angle
    public: bool UpdateHorzAngle(
        uuv_dave_world_ros_plugins_msgs::SetCurrentDirection::Request& _req,
        uuv_dave_world_ros_plugins_msgs::SetCurrentDirection::Response& _res);
