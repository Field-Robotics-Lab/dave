...
### Option A: [Configure Your Host Machine](Install-Directly-on-Host)
...
* This is the simplest option provided you are willing to set up your machine to use the specific version of Ubuntu/ROS/Gazebo listed in the [System Requirements](System-Requirements).

### Option B: [Use a Docker Image](Docker-Development-Image)
...
## Step 2: [Get the Source Code](Clone-Dave-Repositories)
...
* [Install on Windows using WSL2](Install-on-Windows-using-WSL2): Native-like methods to install on Windows 10 or 11